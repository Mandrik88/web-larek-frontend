...
### Слой данных
Класс Component<T>
Базовый абстрактный класс Component служит основой для других классов, упрощая управление элементами DOM. Класс предоставляет методы для работы с элементами: добавление/удаление классов, управление видимостью, текстом, атрибутами и изображениями.Класс Component можно расширять для создания более специфических компонентов интерфейса, предоставляя базовые методы для взаимодействия с элементами DOM
...
- orderProductsResponse — метод отправки данных заказа на сервер 
